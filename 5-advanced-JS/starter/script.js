...
(function quizGame(){
    var firstQuestion, secondQuestion, thirdQuestion, fourthQuestion, fifthQuestion, randomQuestion, questionArr, userAnswer;
    ...
    Question.prototype.randomQuestionLog = function(questions){
    ...
    firstQuestion.randomQuestionLog(questionArr);
    userAnswer = prompt('Please select the correct answer.', '(just type the number)');

    Question.prototype.checkIfCorrect = function(questions, user){
    ...
    firstQuestion.checkIfCorrect(questionArr,userAnswer);
